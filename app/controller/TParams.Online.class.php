<?php 
	...
	class TParams extends Datapacket {
		...
		private $company = "";
		private $HostRoot = "";
		public  $uploads  = "/home1/faustodev/public_html/controleEstoque/uploads/";
		...
		public function __construct(){
			...
			$this->uploads = "/home1/faustodev/public_html/controleEstoque/uploads/";
						
			$lastBar = strrpos($_SERVER['REQUEST_URI'],"/");
			$lastBar = $lastBar-4;
			
			$this->HostRoot ="/home1/faustodev/public_html/controleEstoque/";
			$this->Root = "/home1/faustodev/public_html/controleEstoque/";
			$this->BrowserRoot = "http://fausto.dev/controleEstoque/";
			$this->uploads2 = "http://fausto.dev/controleEstoque/uploads/";
		...
		public function getHost($db){
			return "fausto.dev:faustodev:fau.@2020:faustode_".$db;
		}
