...
Ext.define('FacilDesktop.ux.Video', {
    ...
    initComponent: function () {
        ...
        if (me.fallbackHTML) {
            ...
            if (Ext.isChrome) {
                fallback += 'Atualize o Chrome.';
            } else if (Ext.isGecko) {
                fallback += 'Atualize o Firefox.';
            } else {
                var chrome = '<a href="http://www.google.com/chrome">Chrome</a>';
                fallback += 'Por favor, tente <a href="http://www.mozilla.com">Firefox</a>';

                if (Ext.isIE) {
                    fallback += ', ' + chrome +
                        ' ou <a href="http://www.apple.com/safari/">Safari</a>.';
                } else {
                    fallback += ' ou ' + chrome + '.';
                }
            }
